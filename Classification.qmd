...
if(length(missing_labels) == 0) {
  message("All manual Level2_3 categories exist in the dictionary ✅")
} else {
...
### Nodes and edges for network visualisation

```{r}
write.csv(nodes, "nodes.csv", row.names = FALSE)
write.csv(topic_pairs, "edges.csv", row.names = FALSE)
```
